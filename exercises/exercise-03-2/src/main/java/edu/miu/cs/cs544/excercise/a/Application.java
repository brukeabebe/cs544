...
private static final SessionFactory sessionFactory;
	...
	public static void main(String[] args) {
		...
		try {
			...
			Employee Employee1 = new Employee(123, "Bruke" , department1);
			Employee Employee2= new Employee(453, "Haile " , new Department("Accounting"));
			Employee Employee3 = new Employee(7123, "solomon" , new Department("Logostics"));
