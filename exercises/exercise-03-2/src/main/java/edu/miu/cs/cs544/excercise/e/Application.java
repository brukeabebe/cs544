...
private static final SessionFactory sessionFactory;
	...
	static {
		...
		sessionFactory = HibernateUtils.getSessionFactory(Arrays.asList(Reservation.class , Customer.class, Book.class));
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Create new instance of Employee and set values in i
			...
			Book book3 = new Book("789fgh", "javascript" , "alla");
